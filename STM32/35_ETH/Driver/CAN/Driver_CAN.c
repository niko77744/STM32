...
void Driver_CAN_Init(void) {
    ...
    // 填写屏蔽模式下的ID和mask      
    // 11位stdId  18位EXID IDE RTR 0   -> STDID 低3位是111
    CAN1->sFilterRegister[0].FR1 = 0xFFE00000;  // CAN_TypeDef 下有  CAN_FilterRegister_TypeDef sFilterRegister[14]
    // 掩码  -> 哪些ID需要接收
    CAN1->sFilterRegister[0].FR2 = 0xFFE00000;
